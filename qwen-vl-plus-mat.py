...
IMG_PATH = "./data/memes/"
SAVE_PATH = "./data/meme-cap-main/qwen-vl-plus-mat/zeroshot4.json"
        ...
        messages = [
            ...
            },
            {
                ...
                "content": [
                    ...
                    {"type": "text", "text":
                        f'This is a meme with the title “{title}”. The image description is “{image_caption}”. The following text is written inside the meme: “{ocr_text}”. What is the meme poster trying to convey? ONLY output the answer of the question and the answer should be concise.'}
                ]
            }
        ]
        try:
            answer = dashscope.Generation.call(
                ...
                model="qwen-vl-plus-ft-202505061810-4745-v1",
                messages=messages,
